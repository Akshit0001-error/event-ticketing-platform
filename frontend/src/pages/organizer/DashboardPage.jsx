    ...
    <>
      ...
      <div className="app-content">
        <div className="page-wrap">
          ...
          {/* ── KPI row ──────────────────────────────────────────────── */}
          <div className="dashboard-kpi-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 20 }}>
          ...
          {/* ── Charts row ───────────────────────────────────────────── */}
          <div className="dashboard-charts-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 14, marginBottom: 20 }}>
