  ...
  return (
    <footer className="pn-footer">
      <div className="pn-footer-inner">
        {/* Left — brand */}
        <div className="pn-footer-brand" onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>
          <LogoMark />
        ...
        <div className="pn-footer-links">
          <span className="pn-footer-link" onClick={() => navigate('/browse')}>Browse Events</span>
          <span className="pn-footer-sep">·</span>
          <span className="pn-footer-link" onClick={() => navigate('/login')}>Organize</span>
          <span className="pn-footer-sep">·</span>
          <span className="pn-footer-link" onClick={() => navigate('/register')}>Sign up</span>
        </div>

        {/* Right — social icons */}
        <div className="pn-footer-social">
          {/* GitHub — update href below */}
          <a
